...
<main>
    ...
    <section>
            ...
            @if(Session()->get('direction')=="ltr")
                <div class="col-xs-12"><img src="/images/games-icon.png" alt="" class="icon-title"><h3>{{__($search)}}</h3></div>
            @else
                <div class="col-xs-12 text-right"><h3>{{__($search)}}<img src="/images/games-icon.png" alt="" style="float:right; padding-left:5px; padding-right:0px;" class="icon-title"></h3></div>
            @endif
		    </div>
            <div class="row">
                ...
                @endif
                    ...
                    <figure>
                        ...
                        <figcaption>
                        <ul>
                            <li><a href="/detail/{{$game->id}}"><i class="fa fa-eye fa-3x"></i></a></li>
                        </ul>
                        </figcaption>
                    </figure>
